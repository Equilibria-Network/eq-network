...
the page benefit from a concise claim and a plain-language takeaway. Page-by-page markup would make both
...
- `PageHeaderContent` owns the eyebrow, visible title, concise claim, one- or two-sentence summary, and
