...
export const CARDS: CardDef[] = [
  // Column 0: Foundations
  {
    ...
    fullDescription:
      'A formal framework for representing markets, networks, and democracies as operations on the same underlying structure — typed graphs with well-defined transformation rules. We seek a unified language where coordination mechanisms can be composed and analysed systematically.',
    papers: [
      {
        title: 'Spectral Signatures of Gradual Disempowerment',
        link: 'https://substack.com/home/post/p-187091496',
        status: 'published',
      },
      {
      ...
      {
        title: 'Towards a Langlands Program for CI',
        pdf: '/pdfs/towards-langlands-ci.pdf',
        status: 'wip',
      },
      {
        title: 'Spectral Theory of Memetic Evolution',
  ...
  },
  {
    ...
    fullDescription:
      'A shift from object-oriented to function-oriented thinking about collective systems. Instead of asking "what are the agents?" we ask "what are the functions?" Processes compose over time, enabling a compositional view where mechanisms are built from reusable process primitives.',
    papers: [
      {
        title: 'System Level Safety Evaluations',
        link: 'https://www.lesswrong.com/posts/AJo2HFT8TdY2B3wNJ/system-level-safety-evaluations',
        status: 'published',
      },
      {
        title: 'A Phylogeny of Agents',
        link: 'https://www.lesswrong.com/posts/vqfT5QCWa66gsfziB/a-phylogeny-of-agents',
        status: 'published',
      },
      {
  ...
  },
  {
    ...
    fullDescription:
      'Working with domain experts to express economic theory, political science, social choice theory in terms of one underlying mathematical domain. Which coordination problems matter most? How do existing theories translate?',
    papers: [
      {
  ...
  },
  {
    ...
    fullDescription:
      'Institutional performance decomposes into two layers. Outcomes: welfare, equity, sustainability. Processes: epistemic quality, robustness under adversarial pressure, incentive alignment, information flow quality.',
    papers: [
      {
  ...
  },
  {
    ...
    fullDescription:
      'Social choice theorems tell us about mechanisms in isolation; simulation tells us about mechanisms in composition. Factorial designs crossing mechanism composition x schedule configuration x adversarial pressure.',
  },
  ...
  // Column 1: Construction
  {
    ...
    fullDescription:
      'A JAX-native framework: GraphState, Transform, Schedule, Composition operators. Pure and typed, participates in JAX compilation, vectorisation, and differentiation.',
    papers: [
  ...
  },
  {
    ...
    fullDescription:
      'Institutional mechanisms decomposed into reusable sub-process transforms. Markets, networks, democratic processes — each composable with any other.',
  },
  {
    ...
    fullDescription:
      'Environments demonstrating why composition matters. The fishing commons composes market + network + democracy on a shared resource.',
    papers: [
      {
        title: 'Cultural Evolution of Cognitive Tools',
  ...
  // Column 2: Simulation
  {
    ...
    fullDescription:
      'RL environments where strategic agents attempt to exploit each mechanism composition, producing resilience profiles across adversarial pressures.',
  },
  {
    id: 'llm-simulation',
    col: 2,
    ...
    fullDescription:
      'LLM-based agents simulating social dynamics. Tests whether mechanisms remain robust when participants behave like real people.',
  },
  ...
  },
  {
    ...
    fullDescription:
      'Applying verified mechanisms to research communities for cross-field bridging.',
    papers: [
      {
        title: "The Atoms of Knowledge Aren't Universal",
        link: 'https://equilibria1.substack.com/p/bridges-not-primitives',
        status: 'published',
      },
      {
  ...
  },
  {
    ...
    fullDescription:
      'Applying mechanism design to novel market structures and blockchain coordination.',
  },
  {
    id: 'partner-orgs',
    col: 3,
    ...
    fullDescription:
      'Partnering with organisations already building governance infrastructure to test variations of their existing systems using verified mechanisms.',
  },
];
...
export const ARROWS: ArrowDef[] = [
  ...
  {
    source: 'experimental-methodology',
    target: 'showcase-environments',
    label: 'structures tests for',
  },
