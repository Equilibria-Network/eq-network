  ...
  tracks: [
    {
      ...
      milestones: [
        ...
        { id: 'coupling-contract', label: 'Multi-domain coupling contract', status: 'done' },
        { id: 'metrics-catalog', label: 'Cross-disciplinary catalog', status: 'active' },
        { id: 'coupled-measured', label: 'Coupled system measured end to end', status: 'active' },
        { id: 'run-records', label: 'Metric identity and run manifests', status: 'next' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { id: 'economic-model', label: 'Detailed economic model', status: 'done' },
        { id: 'political-cultural', label: 'Political & cultural models', status: 'done' },
        { id: 'coupled-suite', label: 'Coupled disempowerment suite', status: 'active' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { id: 'contribution-pathway', label: 'Contribution pathway', status: 'active' },
    ...
    },
    {
      ...
      milestones: [
        ...
        { id: 'machine-pages', label: 'Machine-readable scenario pages', status: 'active' },
        { id: 'run-record-pages', label: 'Pages read versioned run records', status: 'next' },
