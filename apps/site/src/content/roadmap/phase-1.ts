      ...
      publications: [
        {
          ...
          description:
            'The core insight—all coordination mechanisms can be understood as message-passing on graphs. Markets pass price signals, networks pass information, democracies pass preferences. Same substrate, different transformation rules.',
          image: null,
          primaryLink: null,
        },
        {
          ...
          medium: 'Research Paper',
          description:
            'Mathematical tools for analyzing collective dynamics through eigenvalue structure. The key concept is "resonance"—when agents\' beliefs align along principal eigenmodes, collective intelligence emerges.',
          image: null,
          primaryLink: null,
        },
        {
          ...
          medium: 'Research Paper',
          description:
            'Exploring whether coordination mechanisms can be formalized as functors with clear composition rules.',
          image: null,
          primaryLink: null,
        },
      ],
      ...
      publications: [
        {
          ...
          medium: 'Blog Post',
          description:
            'Argues AI safety needs to expand from individual-system to multi-agent system evaluation.',
          image: null,
        ...
        },
        {
          ...
          medium: 'Blog Post',
          description:
            'Classification scheme for agent types based on their relationship to prediction and action, drawing on active inference.',
          image: null,
