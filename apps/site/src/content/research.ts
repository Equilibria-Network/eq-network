      ...
      subAreas: [
        {
          ...
          shortDescription:
            'Formal framework treating coordination mechanisms as graph transforms with composition rules.',
          description:
            'A unified formal language where markets, networks, and democracies are operations on the same underlying structure — typed graphs with well-defined transformation rules. Mechanisms compose: you can combine a market with a network and reason about the result. This is the substrate everything else builds on.',
          status: 'active',
          publications: [
        ...
        },
        {
          ...
          shortDescription:
            'Two-layer structure: outcomes we want and processes we think lead there.',
          description:
            'Institutional performance decomposes into two layers. Outcomes are what good institutions produce: welfare, equity, sustainability. Processes are the observable dynamics we hypothesise lead to those outcomes: epistemic quality, robustness under adversarial pressure, incentive alignment, information flow quality. The relationship between these layers is itself an empirical question — discovering which processes reliably predict which outcomes is the core scientific programme.',
          status: 'active',
        },
      ],
    },
    ...
    // ─── Phase 2: Construction ───────────────────────────────────
    {
      ...
      subAreas: [
        ...
        },
        {
          ...
          shortDescription:
            'Demonstration environments where mechanism composition produces non-obvious dynamics.',
          description:
      ...
      subAreas: [
        {
          ...
          shortDescription:
            'Adaptive agents that find optimal exploits for each mechanism composition.',
          description:
            'Reinforcement learning agents (multiplicative weights bandits, varying adversarial fractions) that probe mechanism compositions for vulnerabilities. Each composition is tested across a sweep of adversarial pressures, producing resilience profiles: at what fraction of bad actors does each mechanism combination break? Where are the critical thresholds?',
          status: 'planned',
        },
        {
          id: 'llm-simulation',
        ...
        },
        {
          ...
          shortDescription:
            'Factorial designs, bifurcation analysis, theory as hypothesis generator.',
          description:
            'Systematic experimental methodology: factorial designs crossing mechanism composition × schedule configuration × adversarial pressure. Results presented as bifurcation diagrams showing where mechanisms transition between qualitatively different regimes. Social choice theorems generate hypotheses about individual mechanisms; simulations test those hypotheses under composition.',
          status: 'planned',
        },
      ],
    },
      ...
      subAreas: [
        {
          ...
          shortDescription:
            'The collective intelligence simulation library as a public tool for researchers.',
          description:
            'CI-Lib released as an open-source library that any researcher can use to compose and test coordination mechanisms. The framework becomes infrastructure for the field — not just our internal tool.',
          status: 'planned',
        },
        {
          id: 'desci-lab',
          ...
          description:
            'A product applying verified mechanisms to research communities. Researchers control their own information environment, see their position in the research network, and tune their feed for cross-field bridging. Built on open protocols.',
          status: 'planned',
        },
        {
          id: 'democratic-lab',
          ...
          description:
            'A simulation framework where coordination mechanisms operate as composable graph transformations. Design a governance structure, design an adversary, watch what breaks. A wind tunnel for institutions.',
          status: 'planned',
        },
        {
          ...
          description:
            'Partnering with organisations already building governance infrastructure to test variations of their existing systems based on verified mechanisms. This provides ecological validity and real-world data.',
          status: 'planned',
        },
      ],
    },
